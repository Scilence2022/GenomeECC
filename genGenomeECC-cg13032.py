...
# genome_file = r'/data/songlf/0.DNA_Storage/0.GenomePreservation/genomes/cg13032-ncbi/GCF_002847405.1_ASM284740v1_genomic.fna'
genome_file = r'/data/songlf/2.GenomeCali/05.correct_song_result_20250210/02.WRX_13032/R.13032.fasta'
# genome_file = r'/data/songlf/2.GenomeCali/05.correct_song_result_20250210/02.WRX_13032/01.result.WRX_ATCC13032.fasta'
...
# fq1 = r'/data/songlf/2.GenomeCali/大肠谷棒酵母基因组数据/WRX_13032_S3_R1_001.fastq'
# fq2 = r'/data/songlf/2.GenomeCali/大肠谷棒酵母基因组数据/WRX_13032_S3_R2_001.fastq'
#
# dbg.count_file(fq1)
# dbg.count_file(fq2)

# dbg.count_file('/data/songlf/0.DNA_Storage/0.GenomePreservation/genomes/cg13032-ncbi/GCF_002847405.1_ASM284740v1_genomic.fna.wgsimc.1E6.1.fq')
# dbg.count_file('/data/songlf/0.DNA_Storage/0.GenomePreservation/genomes/cg13032-ncbi/GCF_002847405.1_ASM284740v1_genomic.fna.wgsimc.1E6.2.fq')
...
dbg.ratio_tolerance = 6
dbg.min_kmer_cov = 1
dbg.max_path_num = 5000

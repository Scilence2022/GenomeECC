...
# dbg.count_file('13032_L6_I379.R1.clean.fastq.gz')
dbg.min_kmer_cov = kmer_cov_cutoff
dbg.max_path_num = 20000
dbg.ratio_tolerance = 100
# dbg.block_len = block_len




# seqs = read_fasta(r'/home/lifu/Git_Repositories/GenomePreservation/Cg-Genomes/' + r'GCF_000196335.1_ASM19633v1_genomic.fna')
